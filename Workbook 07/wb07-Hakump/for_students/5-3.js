...
function lightex() {
  ...
  let dir_y = new T.DirectionalLight("yellow", 1);
  dir_y.position.set(10, 0, 0);
  scene.add(dir_y);

  let dir_b = new T.DirectionalLight("blue", 1);
  dir_b.position.set(0, 10, 0);
  scene.add(dir_b);

  let dir_g = new T.DirectionalLight("green", 1);
  dir_g.position.set(0, 0, 10);
  scene.add(dir_g);
